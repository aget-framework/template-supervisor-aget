...
## Project Context
template-supervisor-aget - Supervisor AGET template - v2.5.0
...
**Creation Process**:
1. Copy from template at v2.5.0+ (template-worker-aget or template-supervisor-aget)
...
**Template Locations**:
- `aget-framework/template-worker-aget/` - Public worker agent template (v2.5.0)
- `aget-framework/template-supervisor-aget/` - Supervisor template (v2.5.0)
...
---
*Generated by AGET v2.5.0 - https://github.com/aget-framework/template-supervisor-aget*
