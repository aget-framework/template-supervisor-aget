...
> This strategic vision document now lives in AGET-AGET as part of the governance layer.
> Public implementation details remain in [aget-cli-agent-template](https://github.com/aget-framework/aget).
